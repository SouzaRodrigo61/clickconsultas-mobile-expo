...
import CardEspecialidades from "../components/MaisSobreEspecialidades/CardEspecialidades";
...
export default function MaisSobreEspecialidades({ route }) {
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollcontainer}>
        <CardEspecialidades
          especialidades={route.params.especialidades}
